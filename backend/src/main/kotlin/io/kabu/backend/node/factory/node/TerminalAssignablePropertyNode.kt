...
import io.kabu.backend.declaration.properties.TerminalAssignablePropertyDeclaration
...
class TerminalAssignablePropertyNode(
    name: String,
    typeNode: TypeNode,
    ...
    override fun createDeclarations() = listOf(getTerminalAssignablePropertyDeclaration())

    private fun getTerminalAssignablePropertyDeclaration() = TerminalAssignablePropertyDeclaration(
        name = name,
