 ...
 */
class DerivativeTypeAndDerivativeTypeConflictResolver(private val integrator: Integrator): ConflictResolver {
    ...
    private fun resolveConflict(node1: DerivativeTypeNode, node2: DerivativeTypeNode) {
        ...
        integrator.integrateNode(current) // not resolving but coexisting
    }
}
