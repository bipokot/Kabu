...
asExpression
//    : prefixUnaryExpression (NL* asOperator NL* type)* // we don't need "as" operator
...
callSuffix
//    : typeArguments? (valueArguments? annotatedLambda | valueArguments) // we don't need typeArguments
...
//    | jumpExpression
    : parenthesizedExpression
    | simpleIdentifier
    | literalConstant //todo don't need?
    | functionLiteral
    ;
...
lambdaLiteral
//    : LCURL NL* (lambdaParameters? NL* ARROW NL*)? statements NL* RCURL // we don't need lambda parameters
    : LCURL NL* statements NL* RCURL
    ;
