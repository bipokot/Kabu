...
class UnaryR2C_Test(raw: String, sample: String, termination: String) : R2C_Base(raw, sample, termination) {
...
class UnaryR2C_Management : R2C_Management(TESTED_MANUALLY_PATH, FILEPATH) {
