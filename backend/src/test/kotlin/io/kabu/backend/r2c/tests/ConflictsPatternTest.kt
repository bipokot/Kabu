...
class ConflictsPatternTest(raw: String, sample: String, termination: String) :
...
class ConflictsPatternTestManagement : PatternTestManagement(TESTED_MANUALLY_PATH, FILEPATH) {
