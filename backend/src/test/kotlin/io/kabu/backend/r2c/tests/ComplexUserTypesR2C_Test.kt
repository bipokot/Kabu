...
class ComplexUserTypesR2C_Test(raw: String, sample: String, termination: String) : R2C_Base(raw, sample, termination) {
...
class ComplexUserTypesManagement : R2C_Management(TESTED_MANUALLY_PATH, FILEPATH) {
