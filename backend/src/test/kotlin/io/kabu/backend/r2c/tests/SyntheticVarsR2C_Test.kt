...
private val TESTED_MANUALLY_PATH = getManualPath("syntheticVars")
private val FILEPATH = getDataPath("syntheticVars")

class SyntheticVarsR2C_Test(raw: String, sample: String, termination: String) : R2C_Base(raw, sample, termination) {
...
class SyntheticVarsR2C_Management : R2C_Management(TESTED_MANUALLY_PATH, FILEPATH) {
