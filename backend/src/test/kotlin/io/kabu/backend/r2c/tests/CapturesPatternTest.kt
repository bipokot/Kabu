...
class CapturesPatternTest(raw: String, sample: String, termination: String) :
...
class CapturesPatternTestManagement : PatternTestManagement(TESTED_MANUALLY_PATH, FILEPATH) {
