...
class ReceiverPatternTest(raw: String, sample: String, termination: String) :
...
class ReceiverPatternTestManagement : PatternTestManagement(TESTED_MANUALLY_PATH, FILEPATH) {
