...
private val TESTED_MANUALLY_PATH = getManualPath("nullability")
private val FILEPATH = getDataPath("nullability")

class NullabilityR2C_Test(raw: String, sample: String, termination: String) : R2C_Base(raw, sample, termination) {
...
class NullabilityR2C_Management : R2C_Management(TESTED_MANUALLY_PATH, FILEPATH) {
