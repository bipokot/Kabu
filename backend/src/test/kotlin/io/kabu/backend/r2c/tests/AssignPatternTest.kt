...
class AssignPatternTest(raw: String, sample: String, termination: String) : BasePatternTest(raw, sample, termination) {
...
class AssignPatternTestManagement : PatternTestManagement(TESTED_MANUALLY_PATH, FILEPATH) {
