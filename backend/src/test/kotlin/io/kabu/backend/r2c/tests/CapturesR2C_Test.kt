...
private val TESTED_MANUALLY_PATH = getManualPath("captures")
private val FILEPATH = getDataPath("captures")

class CapturesR2C_Test(raw: String, sample: String, termination: String) : R2C_Base(raw, sample, termination) {
...
class CapturesR2C_Management : R2C_Management(TESTED_MANUALLY_PATH, FILEPATH) {
