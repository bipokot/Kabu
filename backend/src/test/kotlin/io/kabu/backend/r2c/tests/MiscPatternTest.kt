...
private val TESTED_MANUALLY_PATH = getManualPath("misc")
private val FILEPATH = getDataPath("misc")

class MiscPatternTest(raw: String, sample: String, termination: String) : BasePatternTest(raw, sample, termination) {
...
class MiscPatternTestManagement : PatternTestManagement(TESTED_MANUALLY_PATH, FILEPATH) {
