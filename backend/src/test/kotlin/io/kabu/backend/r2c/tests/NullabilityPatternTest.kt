...
class NullabilityPatternTest(raw: String, sample: String, termination: String) :
...
class NullabilityPatternTestManagement : PatternTestManagement(TESTED_MANUALLY_PATH, FILEPATH) {
