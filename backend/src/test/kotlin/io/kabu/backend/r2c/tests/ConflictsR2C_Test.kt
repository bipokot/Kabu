...
private val TESTED_MANUALLY_PATH = getManualPath("conflicts")
private val FILEPATH = getDataPath("conflicts")

class ConflictsR2C_Test(raw: String, sample: String, termination: String) : R2C_Base(raw, sample, termination) {
...
class ConflictsR2C_Management : R2C_Management(TESTED_MANUALLY_PATH, FILEPATH) {
