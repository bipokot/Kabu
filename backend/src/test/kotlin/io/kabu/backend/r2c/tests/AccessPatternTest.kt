...
private val TESTED_MANUALLY_PATH = getManualPath("access")
private val FILEPATH = getDataPath("access")

class AccessPatternTest(raw: String, sample: String, termination: String) : BasePatternTest(raw, sample, termination) {
...
class AccessPatternManagement : PatternTestManagement(TESTED_MANUALLY_PATH, FILEPATH) {
