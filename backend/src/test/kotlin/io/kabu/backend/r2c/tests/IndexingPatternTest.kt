...
class IndexingPatternTest(raw: String, sample: String, termination: String) :
...
class IndexingPatternTestManagement : PatternTestManagement(TESTED_MANUALLY_PATH, FILEPATH) {
